...
module.exports = {
    ...
    data: new SlashCommandBuilder()
            ...
            .addUserOption(u => {
                return u.setName("discord").setDescription("The Discord user of the player (recommended)");
            })
            .addStringOption(o => {
                return o.setName("minecraft").setDescription("The Minecraft username of the player (not recommended)");
            }),
